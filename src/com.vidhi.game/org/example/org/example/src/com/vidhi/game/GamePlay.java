...
public class GamePlay {
    ...
    public void playGame() throws Exception {
        ...
        while (true) {
            ...
            if (playerTurn < 0)
                playerTurn += numOfPlayers; // if playerturn goes to negative integers.
            playerTurn %= numOfPlayers;
            ...
            for (Card currentPlayerCard : players.get(playerTurn).giveCards()) {
                ...
                if (currentPlayerCard.getNumber() == topDiscardCard.getNumber()
                    ...
                    if (topDiscardCard.getNumber() == 1 || topDiscardCard.getNumber() == 11
                        ...
                        if (currentPlayerCard.getNumber() == topDiscardCard.getNumber()) // player cannot play same
                                                                                         // action card even if
                                                                                         // available so he will skip.
                            continue;
                    }
                    // if cards get matched then this statement will be printed.
                    System.out.println("Cards matched for player " + players.get(playerTurn).giveId()
            ...
            if (matched == false) {
                System.out.println("No cards match for player " + players.get(playerTurn).giveId() + " Taking "
                        + numCardsTake + " Card(s)");
                /*
